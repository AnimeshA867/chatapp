...
const page: FC<pageProps> = async ({ params }) => {
  ...
  return (
    <div className="container flex-1 justify-between flex flex-col h-full max-h-[calc(100vh-6rem)] overflow-y-hidden">
      ...
      <Message
        ...
        sessionImg={session.user.image ? session.user.image : "/default.png"}
